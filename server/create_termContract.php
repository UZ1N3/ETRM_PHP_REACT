...
if (!empty($data)) {
        ...
        $query_string = "('" . $data_arr[0] . "', '" . $data_arr[1] . "', '" . $data_arr[2] . "', '" . $data_arr[3] . "', '" . $data_arr[4] . "')";

        $sql = "INSERT INTO termcontract (	counterpartyName, cargoDescription, termContractFrom, termContractTo, Quantity) 
    VALUES " . $query_string;
        $result = $db->query($sql);
